		...
		<div className="flex">
			...
			<main className="bg-slate-900 m-12 p-4 rounded">
				...
				<div className="p-4">
					...
					<input type="text" name="cpf" label="cpf" id="cpf" value={cpf} onChange={(e) => {setCpf(e.target.value)}}/>
					<input type="text" name="cep" label="cep" id="cep" value={cep} onChange={(e) => {setCep(e.target.value)}}/>
					<select name="genero" label="genero" id="genero" value={genero} onChange={(e) => {setGenero(e.target.value)}}>

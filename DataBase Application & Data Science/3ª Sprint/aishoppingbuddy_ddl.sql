...
insert into t_aisb_parceiro_negocio values(100, 'Amazon',  TO_DATE('10/05/2022','DD/MM/YYYY'), 
                                                TO_DATE('','DD/MM/YYYY'), 95831661000175);
...
insert into t_aisb_parceiro_negocio values(106, 'Casas Bahia',  TO_DATE('24/01/2022','DD/MM/YYYY'), 
                                                TO_DATE('','DD/MM/YYYY'), 33547947000176);
...
insert into t_aisb_parceiro_negocio values(108, 'Magazine Luiza',  TO_DATE('16/06/2016','DD/MM/YYYY'), 
                                                TO_DATE('','DD/MM/YYYY'), 11751264000101);
...
insert into t_aisb_funcionario values(120, 'Valerio Durães', 'duraesvalerio@gmail.com', '123', 100);
insert into t_aisb_funcionario values(121, 'Marcos Belutti', 'marcosebelutti@gmail.com', '124', 101);
insert into t_aisb_funcionario values(122, 'Matheus Cauan', 'matheusecauan@gmail.com', '125', 102);
insert into t_aisb_funcionario values(123, 'Luan Santana', 'lu.santana@gmail.com', '126', 103);
insert into t_aisb_funcionario values(124, 'Victor Matheus', 'matheusvictor@gmail.com', '127', 104);
insert into t_aisb_funcionario values(125, 'Karol Dantas', 'karol.dantas@gmail.com', '128', 105);
insert into t_aisb_funcionario values(126, 'Gustavo Lima', 'gustavolima@gmail.com', '129', 106);
insert into t_aisb_funcionario values(127, 'Gizele Almeida', 'gizelealmeida@gmail.com', '130', 107);
insert into t_aisb_funcionario values(128, 'Ana Castelo', 'anacastelo@gmail.com', '131', 108);
insert into t_aisb_funcionario values(129, 'Cleide Santos', 'cleidesanto@gmail.com', '132', 109);
commit;
